...
function StatCard({ title, value, icon, subtitle, gradient }: StatCardProps) {
...
export default function DashboardPage() {
  ...
  React.useEffect(() => {
    ...
    dispatch(fetchTasks());
    if (user?.id) {
      dispatch(fetchNotifications(Number(user.id)));
    }
  }, [dispatch, user]);
  ...
  const stats = [
    ...
    },
    {
      ...
      subtitle: `${users.length - activeUsers} inactive`,
    },
    {
      title: "Total Tasks",
      value: tasks.length,
